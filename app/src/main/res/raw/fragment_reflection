...
void main()
{
	...
	gl_FragColor = vec4(u_Color.rgb * (c_Ambient + diff + spec * u_Specularity.y), u_Color.a * clamp(alphaStart + (alphaFactor.x + alphaFactor.y + alphaFactor.z) * u_AlphaFactor, 0.0, alphaStart));
}
