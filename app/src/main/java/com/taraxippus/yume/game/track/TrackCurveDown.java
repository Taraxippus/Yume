...
public class TrackCurveDown extends Track
{
	...
	public TrackCurveDown(World world, float z, boolean tube)
	{
		super(world, z, tube);
	}
	...
	public void create()
	{
		...
		Matrix.rotateM(nextMatrix, 0, 90, 1, 0, 0);
		nextRotation.multiplyRightByAngleAxis((float) Math.PI / 2F, 1, 0, 0);
	}
